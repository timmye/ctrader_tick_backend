...
class CTraderConnection extends EventEmitter {
    ...
    sendCommand(payloadType, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientMsgId = uuid_1.v1();
            const normalizedPayloadType = typeof payloadType === "number" ? payloadType : this.getPayloadTypeByName(payloadType);
    ...
    on(type, listener) {
        const normalizedType = Number.isFinite(Number.parseInt(type, 10)) ? type : this.getPayloadTypeByName(type).toString();
